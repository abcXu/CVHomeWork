...
def get_args():
    ...
    # 海温预测数据集
    parser.add_argument('--model', default='SwinLSTM-D', type=str, choices=['SwinLSTM-B', 'SwinLSTM-D','DatLSTM'],
                        help='Model type')
    ...
    parser.add_argument('--epoch_valid', default=4, type=int)
    parser.add_argument('--log_train', default=100, type=int)
    parser.add_argument('--log_valid', default=10, type=int)
    parser.add_argument('--lr', default=0.0001, type=float, help='Learning rate')
    parser.add_argument('--data_split_ratio',default=[0.6,0.2,0.2],help='the ratio of train valid test')
    # 预测
    parser.add_argument('--test_data_save_dir',default='./results/predict/')
    # parser.add_argument('--test_year_time', default='20201115_20210315', type=str)
    # parser.add_argument('--data_name', type=str, default='Bohai_sic')  # farSea、high、low、middle、Bohai
